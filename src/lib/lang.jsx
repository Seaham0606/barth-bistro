...
export const BB_STRINGS = {
  ...
  receivedSub:    { en: 'Your request is being prepared',   zh: '您的預約正在安排中' },
  receivedBody:   { en: 'Our chef will review your request and follow up with confirmation and pairing suggestions.',
                    zh: '主廚將查看您的預約，並回覆確認安排及推薦搭配。' },
