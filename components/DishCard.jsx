...
// Props:
//  - dish: dish object
//  - composeMode, selected, onToggle
// Lang:
//  - en mode: english dish name (large) + english description
//  - zh mode: chinese dish name (large) + chinese description
function DishCard({ dish, composeMode, selected, onToggle }) {
  const [lang] = useLang();
  if (!dish) return null;
