// ChefForm — collects guest details + a note for the chef
// Invite-only: we already know the guest's name, no need for phone.
// Props:
//  - onBack: () => void   (return to dish review)
//  - onSubmit: (formData) => void
//  - dishCount: number
function ChefForm({ onBack, onSubmit, dishCount }) {
